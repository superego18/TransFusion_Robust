...
def show_result(points, gt_bboxes, pred_bboxes, out_dir, filename, show=True):
    ...
    if show:
        ...
        if pred_bboxes is not None:
            vis.add_bboxes(bbox3d=pred_bboxes, bbox_color=(1, 0, 0), points_in_box_color=(1, 0, 0))
        if gt_bboxes is not None:
            vis.add_bboxes(bbox3d=gt_bboxes, bbox_color=(0, 1, 0), points_in_box_color=(0, 1, 0))
        vis.show()
